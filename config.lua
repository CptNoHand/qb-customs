...
bennyGarages = {
    [1] = {coords = vector4(-488.18, -4211.25, -15.71, 343.87), blip = true, useJob = false, job = {"mechanic", "police"}},
    [2] = {coords = vector4(-510.13, -4202.98, -15.54, 73.46), blip = true, useJob = true, job = {"mechanic"}}
}
